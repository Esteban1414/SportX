...
$db_user_name = 'root';
$db_user_pass = '';
if (isset($_GET['table']) ? $_GET['table'] : 'activity_log_orders') {
    $orders = isset($_GET['table']) ? $_GET['table'] : 'activity_log_orders';
    try {
        ...
        $query = "SELECT id_user, id_order, action, ip_address, date FROM $orders";
