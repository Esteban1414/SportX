...
$db_user_name = 'root';
$db_user_pass = '';
if (isset($_GET['table']) ? $_GET['table'] : 'activity_log_products') {
    $products = isset($_GET['table']) ? $_GET['table'] : 'activity_log_orders';
    try {
        ...
        $query = "SELECT id_user, id_product, action, ip_address, date FROM $products";
